...
Goal
	...
	Why
		...
		- Because people already use technologies/tools in order to increase their consciousness (in the form of rituals, practices, substances, sounds, places, spaces, stories, breathing, mindset), but maybe electrical technologies have not been used as much as they could
    - Because electrical technologies are extremely widespread in humanity, and tools within them can be spread very rapidly and influentially
		- Because I could not find similar work being done in this area, or the work being done is not prominent enough for what society needs
	What
		...
		- Expand consciousness
			...
			Consciousness can be expanded though the body, mind, emotions, or energy. For example, in terms of the body, an increase in consciousness can be seen as the difference between doing a given physical action with a certain muscle contracted while not being aware of it, and doing the same action with the same muscle relaxed because one was aware of it and therefore was able to relax it. It is less important to focus on what the goal looks like than it is to focus on what are the compulsions you want to be freed from, and work on them.
	When
		ASAP
	Where
	...
	How
		...
		- By continuing my own practices.
    - By focusing on the body, mind, emotions, and energy
		- By considering electrical technologies as a whole and proposing solutions that achieve the proposed goal through a unified approach for all electrical technologies
		- By producing the materials (visual, auditory, written), standards, assets, conversations, communities, education, experiences, and products needed to establish, promote, and experience this goal
		- By preferring one to one interactions when aiming to have people have deep discussions
			Interactions with 3 or more people tend to invite people to unconsciously place more energy in using one of their personalities, as everything they do or say, no matter who it is directed to, may be being judged by the third person. Personalities are all created in order to survive, but they don't really represent who we truly are and what we really want, deep down
		- By considering what electrical technologies are most widespread, easiest to spread, more aligned with how reality operates, provide more sustainable wellbeing, and starting with them
			In order, from most to least widespread
				1. Analog
					[TO DO]
				2. Digital
					- General
						- All digital technologies, but specially those prone to be used in a manner that facilitates users letting themselves forget the intention with which they opened the app in the first place, should provide tools to stay mindful of this intent.
							- The app could greet you by asking you what your intent it, and keeping it in the top of your view
							- It could detect when you are veering off your intent, and guiding you towards it
					- Hardware
						1. smartphones
							...
							Pros:
								...
								- Connection
							Cons:
								- Modern phone's battery capacity is very limited, or requre knowledge and awareness to manage battery availability. Most are designed to be charged overnight daily.
								...
								- Not accessible to certain populations `</Smartphones>`
						2. computers
	...
	Afterword
		...
		If you have anything to tell me about this project
			For example, if you
				- are interested,
				- have suggestions,
				- are working on something similar,
				- know of a someone working on this, or
				- know someone who is working on something similar,
