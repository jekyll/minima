...
Refers to `.scss` files within the `_sass` directory that define the theme's styles.
  ...
  - `minima/skins/classic.scss` &mdash; The "classic" skin of the theme.
...
A skin is a Sass file placed in the path `minima/skins/*`. It defines the
...
The default color palette for Minima is defined within `_sass/minima/skins/classic.scss`. To switch to another available skin, simply
declare it in the site's config file. For example, to activate `_sass/minima/skins/sunrise.scss` as the skin, the setting would be:
