...
* [08-12-21](https://twitter.com/polyquantique/status/1468772841722109953) [Mr Mustard](https://github.com/xanaduAI/Mrmustard), that I helped develope with folks from [Xanadu Quantum Technologies](https://xanadu.ai) is out. For a nice example of Mr Mustard in action see this [Jupyter notebook](https://github.com/polyquantique/mrmustard_examples/blob/main/making_cats.ipynb) where I use it to find a circuit to find a heralding circuit for making a big cat state.
